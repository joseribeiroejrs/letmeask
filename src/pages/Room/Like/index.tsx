...
export const Like = ({ question }: LikeType): JSX.Element => {
	const { user } = useAuth();
	...
	const getLikeCount = (question: QuestionType) => {
		return question.likeCount > 0 && <span>{question.likeCount}</span>;
	};
